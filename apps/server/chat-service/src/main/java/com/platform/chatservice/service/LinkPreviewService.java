 ...
 * sites, so the Flutter client calls this instead.
 *
 * <p>Kept dependency-free: uses the JDK {@link HttpClient} and lightweight regex parsing of {@code
 * <meta property="og:*">} / {@code <title>} tags. A short timeout, a capped read size and an
 * http(s)-only guard keep it well-behaved.
 */
@Service
