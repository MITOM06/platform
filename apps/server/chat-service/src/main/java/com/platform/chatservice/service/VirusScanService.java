 ...
 *
 * <p>The production implementation should integrate with ClamAV (clamd socket) or a cloud scanning
 * API (e.g., VirusTotal). The default bean {@link NoOpVirusScanService} is a no-op stub that logs
 * and passes through.
 */
