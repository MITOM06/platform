...
/**
 * Maps {@link Message} documents to {@link MessageResponse} DTOs. Extracted from
 * {@code MessageService} so collaborator services (AI persistence, sweeps) can
 * reuse the exact same projection without duplicating it.
 */
@Component
