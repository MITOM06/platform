...
/**
 * AI message persistence + trace retrieval. Extracted from {@code MessageService}
 * to keep that class within the clean-code line limit. Behavior is unchanged:
 * {@link #saveAiMessage} still performs the single broadcast of the saved AI
 * message to the conversation topic.
 */
@Service
