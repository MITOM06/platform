...
class _AdminScreenState extends ConsumerState<AdminScreen> {
  ...
  List<_Section> _sections() => [
        _Section(Cap.manageWorkspace, Icons.business_rounded,
            (c) => c.l10n.adminNavWorkspace, const WorkspacePanel()),
        _Section(Cap.manageWorkspace, Icons.auto_awesome_rounded,
            (c) => c.l10n.adminNavAi, const WorkspaceAiSettingsPanel()),
        _Section(Cap.manageWorkspace, Icons.smart_toy_rounded,
            (c) => c.l10n.botAdminTitle, const BotIntegrationPanel()),
        _Section(Cap.manageWorkspace, Icons.insights_rounded,
            (c) => c.l10n.adminNavUsage, const UsageDashboardPanel()),
        _Section(Cap.manageWorkspace, Icons.vpn_key_rounded,
            (c) => c.l10n.adminNavSso, const SsoPanel()),
        _Section(Cap.manageDepartments, Icons.groups_rounded,
            (c) => c.l10n.adminNavDepartments, const DepartmentsPanel()),
        _Section(Cap.manageMembers, Icons.people_outline_rounded,
            (c) => c.l10n.adminNavMembers, const MembersPanel()),
        _Section(Cap.manageRoles, Icons.shield_rounded,
            (c) => c.l10n.adminNavRoles, const RolesPanel()),
        _Section(Cap.manageAiContext, Icons.psychology_rounded,
            (c) => c.l10n.adminAiContextEntriesTitle,
            const AiContextEntriesPanel()),
        _Section(Cap.viewAuditLog, Icons.fact_check_rounded,
