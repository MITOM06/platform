  ...
  if (!assistant) {
    return (
      <Link
        ...
        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl justify-center @[300px]:justify-start
      ...
      >
        ...
        <div className="hidden @[300px]:flex flex-col min-w-0">
  ...
  return (
    <div className="relative mb-1 motion-safe:pon-enter">
      <button
        ...
        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl justify-center @[300px]:justify-start
                   hover:bg-accent transition-[background-color,transform] duration-[180ms]
                   active:scale-[0.98] text-left disabled:opacity-60 pr-3 @[300px]:pr-12"
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 size-8 rounded-lg
                   hidden @[300px]:flex items-center justify-center text-muted-foreground
