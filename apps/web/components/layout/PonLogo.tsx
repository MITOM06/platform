...
// The neon 3-stop gradient is gone: the mark is now a single flat accent shape
// that inherits `currentColor`, so it follows the burgundy `--primary` token in
// both light and dark without a second source of truth.
